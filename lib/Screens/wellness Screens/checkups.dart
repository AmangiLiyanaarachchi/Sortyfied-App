...
import 'package:sortifyd_app/Screens/wellness%20Screens/add_record.dart';
import 'package:sortifyd_app/Screens/wellness%20Screens/add_visit.dart';
      ...
      child: ScaleTransition(
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                "Maintain a record of your medical checkups and visits",
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                        "Click, tag and save photos of items(lab results, medical reports, etc)"),
                  ),
                ],
              ),
              SizedBox(height: 5),
...
class CheackupsScreen extends StatelessWidget {
  const CheackupsScreen({super.key});
