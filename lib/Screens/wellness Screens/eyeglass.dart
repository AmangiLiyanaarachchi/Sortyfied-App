...
import 'package:sortifyd_app/Screens/wellness%20Screens/add-medication.dart';
import 'package:sortifyd_app/Screens/wellness%20Screens/add_prescription.dart';
      ...
      child: ScaleTransition(
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                "Have ready access to your eyeglass prescription when you need to get your glasses made",
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Expanded(
                    child: Text("Tap '+' below to add a record"),
                  ),
                ],
              ),
              SizedBox(height: 5),
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                        "Click, tag and save photos of items(prescriptions, photos of eyeglass frames you like, etc)"),
                  ),
                ],
              ),
              SizedBox(height: 5),
...
class EyeglassScreen extends StatelessWidget {
  const EyeglassScreen({super.key});
