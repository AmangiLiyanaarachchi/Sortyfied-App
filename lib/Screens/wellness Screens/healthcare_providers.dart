      ...
      child: ScaleTransition(
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                "Have ready access to your healthcare provider contact information and account credentials",
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                        "Click, tag and save photos of iyems(brochures, business cards, etc)"),
                  ),
                ],
              ),
              SizedBox(height: 5),
...
class HealthcareProvidersScreen extends StatelessWidget {
